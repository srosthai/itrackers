...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'transactions.subCategory': 'Sub-category',
        'transactions.selectSubCategory': 'Select Sub-category',
    ...
    km: {
        ...
        'transactions.subCategory': 'ប្រភេទរង',
        'transactions.selectSubCategory': 'ជ្រើសរើសប្រភេទរង',
        'transactions.none': 'គ្មាន',
